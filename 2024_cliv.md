...
go to the directory `bams_merged` and execute script:
```
sbatch 2024_samtools_merge2.sh fem_cliv_CAS262485_S2_L001/CAS262485_S2_L001__sorted.bam fem_cliv_CAS262485_S2_L002/CAS262485_S2_L002__sorted.bam
```
